...
<h1>
	<p class="pull-right">
	<a href="/admin/user_preferences" class="btn btn-default" title="{{ trans('kotoba::button.back') }}">
...
<div class="row">
<div class="col-sm-6">
	<a href="/admin/user_preferences" class="btn btn-default btn-block" title="{{ trans('kotoba::button.cancel') }}">
